...
class FourMAStrategy(Strategy):
    """Buy when all 4 MAs align bullish (MA1>MA2>MA3>MA4), sell on bearish alignment."""
...
STRATEGY_REGISTRY = {
    ...
    "4 MA Crossover": {
        ...
        "description": "Buy when 4 MAs align bullish (MA1>MA2>MA3>MA4), sell on bearish alignment.",
        "params": {
            "use_ema": {"label": "Use EMA (unchecked = SMA)", "default": False},
            "ma1_period": {"label": "MA 1 Period", "min": 2, "max": 100, "default": 5},
            "ma2_period": {"label": "MA 2 Period", "min": 2, "max": 100, "default": 10},
            "ma3_period": {"label": "MA 3 Period", "min": 2, "max": 200, "default": 20},
            "ma4_period": {"label": "MA 4 Period", "min": 2, "max": 500, "default": 50},
        },
    },
}
